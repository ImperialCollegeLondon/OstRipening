# OstRipening - pore network flow simulation for Ostwald ripening

This repository hosts the network flow simulation code for simulating Ostwald ripening in a two-phase system. PnflowPy code was extended to simulate Ostwald ripening.
